...
class SightingRecord(BaseModel):
    """One sighting of an indicator, annotated with its full provenance."""
...
class FederatedSightingsResult(MultiServerResult[list[SightingRecord]]):
    """Aggregated fleet-wide sighting lookup for one indicator value."""
